...
const namespace = 'org.taller.atun';
/*
...
*/
const pescadorType = "Pescador";
const pescadorNS = namespace + '.' + pescadorType;
...
describe('#' + namespace, () => {
   ...
   // const bobCardName = 'bob';
    ...
    const pescadorCardName = 'pescador'
    ...
    beforeEach(async () => {
        ...
        let participantRegistry = await businessNetworkConnection.getParticipantRegistry(pescadorNS);
/*
        ...
        participantRegistry = await businessNetworkConnection.getParticipantRegistry(pescadorNS);
*/
        const pescador = factory.newResource(namespace, pescadorType, 'pescador1');
        pescador.organizacion = 'Emp1';
        let direccion = factory.newConcept(namespace, 'Direccion');
            direccion.pais = "AR";
            direccion.cpostal = "11000";
        pescador.direccion = direccion;

        await participantRegistry.add(pescador);
...
*/
    ...
    //    let identity = await businessNetworkConnection.issueIdentity(participantNS + '#alice@email.com', 'alice1');
     //   await importCardForIdentity(aliceCardName, identity);
       ...
       // await importCardForIdentity(bobCardName, identity);
        ...
        let identity = await businessNetworkConnection.issueIdentity(pescadorNS + '#pescador1', 'pescador1');
        await importCardForIdentity(pescadorCardName, identity);
    });
    ...
    it.only('Probando las funcionalidades del negocio', async () => {
        // Use the identity for Alice.
        await useIdentity(pescadorCardName);
